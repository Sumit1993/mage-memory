...
[ADR-0018 (now ADR-0052)](../decisions/0052-streams-and-the-observe-schema.md) makes lens ① (user
...
[ADR-0015 (now ADR-0052)](../decisions/0052-streams-and-the-observe-schema.md)'s `user_prompt` event should not
...
- Lens definitions and the first-sight gate:
  [ADR-0018](../decisions/0052-streams-and-the-observe-schema.md)
- The event schema that records the messages:
  [ADR-0015](../decisions/0052-streams-and-the-observe-schema.md)
