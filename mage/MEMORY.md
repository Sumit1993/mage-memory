...
> 67 notes across 1 wing. Generated by `mage index`.
...
- `note` [0.1.0 is gated on ADR-0031 Phase 2 — the reject-ledger reconciler (unbuilt)](notes/phase2-reject-ledger-0.1.0-gate.md) — 0.1.0, gate, adr-0031, phase-2, reject-ledger, keep-rate, reconciler, provenance-source, capture-vs-adopt, a1-bake, autonomy, crown-threshold _(reviewed 2026-07-12)_
