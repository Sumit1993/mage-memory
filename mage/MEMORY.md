...
- `gotcha` [Gotcha — ctx_execute_file refuses any path outside the project root, and the scratchpad always is](notes/context-mode-blocks-files-outside-project-root.md) — ai-context, file-access-blocked, allow-rule, sandbox
