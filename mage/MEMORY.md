...
- `decision` [0041 — Genre decides the recall rung: one store, three recall paths (amends ADR-0035)](decisions/0041-genre-decides-the-recall-rung.md) — closed-type-vocabulary, type-genre-map, index-exclusion, governance-line, lifecycle-verbs, annotate-never-sort, migration-manifest
