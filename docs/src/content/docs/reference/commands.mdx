...
`mage doctor` diagnoses environment, knowledge-base, and connection health, including read-only genre-tell annotations (over-cap size, done-state vocabulary, issue-ref density, checkboxes).
