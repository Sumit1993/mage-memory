...
discover your knowledge base. Each generated wing skill includes a "Governing decisions" section listing all accepted, non-superseded decision records (ADRs) linked from that wing's notes.
